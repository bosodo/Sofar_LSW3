...
prometheus_file_name = configParser.get('Prometheus', 'prometheus_file')
                ...
                for register in item["registers"]:
                    if register == hexpos and chunks != -1:
                        ...
                        if hexpos != '0x0015' and hexpos != '0x0016' and hexpos != '0x0017' and hexpos != '0x0018':
                            ...
                            if influxdb == "1" and graph == 1:
                                PrepareInfluxData(InfluxData, metric_name.split('_')[0] + "_" + label_value, response)
                        ...
                        if hexpos == '0x0016':
                            ...
                            if influxdb == "1" and graph == 1:
                                PrepareInfluxData(InfluxData, metric_name.split('_')[0] + "_" + label_value, totalpower)
                            if DomoticzSupport == "1" and DomoticzIdx > 0:
                                PrepareDomoticzData(DomoticzData, DomoticzIdx, response)
                        if hexpos == '0x0017':
                        ...
                        if hexpos == '0x0018':
                            ...
                            if influxdb == "1" and graph == 1:
                                PrepareInfluxData(InfluxData, metric_name.split('_')[0] + "_" + label_value, totaltime)
                            if DomoticzSupport == "1" and DomoticzIdx > 0:
                                PrepareDomoticzData(DomoticzData, DomoticzIdx, response)
        a += 1
    if chunks == 0:
...
if prometheus == "1" and invstatus == 1:
    prometheus_file = open(prometheus_file_name, "w")
